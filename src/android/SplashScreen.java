    ...
    private void showSplashScreen(final boolean hideAfterDelay) {
        ...
        cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                ...
                String statusBarColor = preferences.getString("SplashStatusBarBackgroundColor", "#00bfff");
                ...
                String navigationBarColor = preferences.getString("SplashNavigationBarBackgroundColor", "#00bfff");
